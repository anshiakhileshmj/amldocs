...
export default function Register() {
  ...
  return (
    <>
      <Head>
        <title>Register - Stablecoin Merchant</title>
      </Head>
          ...
          <div className="card">
            {!showApiKey ? (
              ...
              <div className="space-y-6">
                ...
                <div className="bg-yarning-50 border border-warning-200 rounded-lg p-4">
                ...
                <div className="flex space-x-3">
                  <Link href="/login" className="flex-1 btn btn-primary">
                    Sign In
                  </Link>
                  <a
                    href="/docs"
            ...
            <div className="mt-6">
              ...
              <div className="mt-6">
                <Link href="/login" className="w-full btn btn-secondary flex justify-center">
                  Sign In Instead
                </Link>
              </div>
            </div>
