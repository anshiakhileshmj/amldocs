...
export default function Login() {
  ...
  return (
    <>
      <Head>
        <title>Login - Stablecoin Merchant</title>
      </Head>
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="card">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">
                  Don't have an API key? <Link href="/register" className="text-primary-600 hover:text-primary-500">Create an account</Link>
                </p>
              </div>
            ...
            <div className="mt-6">
              ...
              <div className="mt-6">
                <Link href="/register" className="w-full btn btn-secondary flex justify-center">
                  Create New Account
                </Link>
              </div>
            </div>
